...
void test_read_polyline_order(void)
{
	...
	CU_ASSERT(polyline.points[0].x == 374);
	CU_ASSERT(polyline.points[0].y == 686);
	CU_ASSERT(polyline.points[1].x == 183);
	CU_ASSERT(polyline.points[1].y == 666);
	CU_ASSERT(polyline.points[2].x == -37);
	CU_ASSERT(polyline.points[2].y == 636);
	CU_ASSERT(polyline.points[3].x == -250);
	CU_ASSERT(polyline.points[3].y == 597);
	CU_ASSERT(polyline.points[4].x == -421);
	CU_ASSERT(polyline.points[4].y == 550);
	CU_ASSERT(polyline.points[5].x == -521);
	CU_ASSERT(polyline.points[5].y == 495);
	CU_ASSERT(polyline.points[6].x == -534);
	CU_ASSERT(polyline.points[6].y == 434);
	CU_ASSERT(polyline.points[7].x == -457);
	CU_ASSERT(polyline.points[7].y == 368);
	CU_ASSERT(polyline.points[8].x == -304);
	CU_ASSERT(polyline.points[8].y == 298);
	CU_ASSERT(polyline.points[9].x == -99);
	CU_ASSERT(polyline.points[9].y == 225);
	CU_ASSERT(polyline.points[10].x == 123);
	CU_ASSERT(polyline.points[10].y == 151);
	CU_ASSERT(polyline.points[11].x == 325);
	CU_ASSERT(polyline.points[11].y == 77);
	CU_ASSERT(polyline.points[12].x == 475);
	CU_ASSERT(polyline.points[12].y == 4);
	CU_ASSERT(polyline.points[13].x == 547);
	CU_ASSERT(polyline.points[13].y == -66);
	CU_ASSERT(polyline.points[14].x == 530);
	CU_ASSERT(polyline.points[14].y == -132);
	CU_ASSERT(polyline.points[15].x == 425);
	CU_ASSERT(polyline.points[15].y == -193);
	CU_ASSERT(polyline.points[16].x == 251);
	CU_ASSERT(polyline.points[16].y == -247);
	CU_ASSERT(polyline.points[17].x == 38);
	CU_ASSERT(polyline.points[17].y == -294);
	CU_ASSERT(polyline.points[18].x == -182);
	CU_ASSERT(polyline.points[18].y == -333);
	CU_ASSERT(polyline.points[19].x == -370);
	CU_ASSERT(polyline.points[19].y == -362);
	CU_ASSERT(polyline.points[20].x == -497);
	CU_ASSERT(polyline.points[20].y == -382);
	CU_ASSERT(polyline.points[21].x == -539);
	CU_ASSERT(polyline.points[21].y == -392);
	CU_ASSERT(polyline.points[22].x == -492);
	CU_ASSERT(polyline.points[22].y == -392);
	CU_ASSERT(polyline.points[23].x == -362);
	CU_ASSERT(polyline.points[23].y == -382);
	CU_ASSERT(polyline.points[24].x == -171);
	CU_ASSERT(polyline.points[24].y == -362);
	CU_ASSERT(polyline.points[25].x == 50);
	CU_ASSERT(polyline.points[25].y == -332);
	CU_ASSERT(polyline.points[26].x == 262);
	CU_ASSERT(polyline.points[26].y == -293);
	CU_ASSERT(polyline.points[27].x == 433);
	CU_ASSERT(polyline.points[27].y == -246);
	CU_ASSERT(polyline.points[28].x == 533);
	CU_ASSERT(polyline.points[28].y == -191);
	CU_ASSERT(polyline.points[29].x == 546);
	CU_ASSERT(polyline.points[29].y == -130);
	CU_ASSERT(polyline.points[30].x == 469);
	CU_ASSERT(polyline.points[30].y == -64);
	CU_ASSERT(polyline.points[31].x == 316);
	CU_ASSERT(polyline.points[31].y == 6);
